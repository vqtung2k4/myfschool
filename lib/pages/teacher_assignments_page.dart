...
class _CreateAssignmentPageState extends State<CreateAssignmentPage> {
  ...
  final List<String> _subjects = ["Japanese", "Mathematics", "Science", "English", "Art"];
      ...
      body: _isLoadingClass 
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              // --- 1. Class Selection (Restricted to Teacher's Class) ---
              const Text("Your Class", style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: null, // Keep it disabled as they only have one class
                validator: (val) => val == null ? "No class assigned to your profile" : null,
              ),
  ...
  InputDecoration _dropdownStyle() => InputDecoration(
    filled: true,
    fillColor: Colors.grey[200], // Slightly darker to indicate read-only status
      ...
      children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Text(_selectedDueDate == null ? "Not selected" : DateFormat('dd/MM/yyyy').format(_selectedDueDate!)),
          ],
        ),
        ElevatedButton(
          onPressed: () async {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: _isSaving
            ...
            : const Text("Post Assignment", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
    );
  }
